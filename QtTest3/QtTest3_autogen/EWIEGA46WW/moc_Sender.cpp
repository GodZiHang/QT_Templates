...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Sender_t, stringdata0) + ofs), len 
...
void Sender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sender::ageChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Sender::staticMetaObject = { {
    ...
    qt_meta_stringdata_Sender.offsetsAndSize,
    qt_meta_data_Sender,
    qt_static_metacall,
    nullptr,
...
// SIGNAL 0
void Sender::ageChanged(int _t1)
{
